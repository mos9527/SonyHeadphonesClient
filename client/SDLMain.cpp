...
int main(int, char**)
{
    ...
    style.Colors[ImGuiCol_WindowBg] = ImVec4(0.96f, 0.96f, 0.97f, 1.0f);
    style.Colors[ImGuiCol_ChildBg] = ImVec4(0.99f, 0.99f, 1.0f, 0.94f);
    style.Colors[ImGuiCol_PopupBg] = ImVec4(0.98f, 0.98f, 0.99f, 0.98f);
    style.Colors[ImGuiCol_Border] = ImVec4(0.87f, 0.88f, 0.90f, 1.0f);
    style.Colors[ImGuiCol_FrameBg] = ImVec4(0.93f, 0.94f, 0.96f, 1.0f);
    style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.86f, 0.90f, 0.96f, 1.0f);
    style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.80f, 0.86f, 0.95f, 1.0f);
    ...
    style.Colors[ImGuiCol_MenuBarBg] = ImVec4(0.94f, 0.95f, 0.97f, 1.0f);
    style.Colors[ImGuiCol_Header] = ImVec4(0.80f, 0.88f, 0.98f, 0.75f);
    style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.70f, 0.84f, 0.98f, 0.9f);
    style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.56f, 0.78f, 0.98f, 1.0f);
    ...
    style.Colors[ImGuiCol_Tab] = ImVec4(0.90f, 0.91f, 0.94f, 1.0f);
    style.Colors[ImGuiCol_TabHovered] = ImVec4(0.72f, 0.84f, 0.98f, 0.9f);
    style.Colors[ImGuiCol_TabActive] = ImVec4(0.72f, 0.84f, 0.98f, 1.0f);
    style.Colors[ImGuiCol_Separator] = ImVec4(0.86f, 0.87f, 0.9f, 1.0f);
    style.Colors[ImGuiCol_SeparatorHovered] = ImVec4(0.67f, 0.78f, 0.94f, 1.0f);
    style.Colors[ImGuiCol_SeparatorActive] = ImVec4(0.58f, 0.72f, 0.92f, 1.0f);

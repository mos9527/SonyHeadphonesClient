// Patched version of material-color-utilities/cpp/utils/utils.cc
// Changes from upstream:
//   - Removed absl/strings/str_cat.h dependency
//   - HexFromArgb reimplemented with snprintf
//   - Added _USE_MATH_DEFINES for MSVC M_PI support
//
// Original copyright:
// Copyright 2022 Google LLC (Apache License 2.0)
...
int Delinearized(const double rgb_component) {
  ...
  return std::clamp(static_cast<int>(round(delinearized * 255.0)), 0, 255);
}
...
// Reimplemented without absl dependency
